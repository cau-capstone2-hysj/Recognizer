...
Webcam or Image -- (holistic_pipeline) --> MpResult
"""
...
class MpHolistic:
    ...
    def process(self) -> MpResult:
        """
        make inference of mediapipe model, from image or webcam,
        construct a MpResult object and returns it
        """
...
def _get_framesource(image_dir: Optional[str]) -> Iterator[np.ndarray]:
    ...
    else, image from image_dir is used repeatedly
    """
    __camera = None
    __img = None
    while 1:
